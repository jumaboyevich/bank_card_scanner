...
public abstract class ScanBaseActivity extends Activity implements Camera.PreviewCallback,
    ...
    public static String RESULT_PERMISSION_DENIED = "result_permission_denied";
    ...
    public void onClick(View view) {
        if (mCamera != null && mFlashlightId == view.getId()) {
            ...
            if (parameters.getFlashMode().equals(Camera.Parameters.FLASH_MODE_TORCH)) {
                ...
                view.findViewById(mFlashlightId).setBackgroundDrawable(AppCompatResources.getDrawable(this, R.drawable.is_select_flashlight));
            }
            setCameraParameters(mCamera, parameters);
    ...
    public void onBackPressed() {
        if (!mSentResponse && mIsActivityActive) {
            ...
            mSentResponse = true;
            Intent intent = new Intent();
            intent.putExtra(RESULT_PERMISSION_DENIED, wasPermissionDenied);
            setResult(RESULT_CANCELED, intent);
            finish();
